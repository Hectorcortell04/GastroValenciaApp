...
interface RestaurantApi {
    ...
    suspend fun getRestaurantById(@Path("restaurantId") restaurantId: String, @Path("userId") userId: String): RestaurantDto
    ...
    suspend fun likeRestaurants(@Path("restaurantId") eventId: String, @Path("userId") userId: String)
}